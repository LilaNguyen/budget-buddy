...
public class ViewReportsController {
	...
	public void handleViewDetails() {
	    ...
	    try {
	        ...
	        URL url = getClass().getClassLoader().getResource("view/ViewReportDetail.fxml");
	        FXMLLoader loader = new FXMLLoader(url);
	        AnchorPane pane = loader.load();

	        // Pass data to the detail page controller
	        ViewTransactionDetailController controller = loader.getController();
	        controller.setTransactionData(selectedTransaction);

	        // Replace the current content with the detail page
	        HBox mainBox = CommonObjs.getInstance().getMainBox();
